...
#Bem-vindo à máquina de venda automatica de ingressos de Cinema!

# Solicita a idade para sugestão de filmes
idade = int(input("Por favor, digite sua idade:"))

# verifica a idade para sugestão de filmes
if idade < 12:
    print("Recomendamos o filmes infantil FILME 1.")
elif 12 <= idade < 18:
...
else: print("Desculpe, todos os ingressos estão esgotados para hoje.")